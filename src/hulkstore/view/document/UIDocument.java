package hulkstore_.view.document;
...
/**
 * Main view of Document Management.
 * 
 * @author Luis Mercado
 * @version 0.1
 * @since 2020-03-11
 */
public class UIDocument extends javax.swing.JFrame {
    
    private CDocument controller;
     ...
     * @param controller 
     */
    public UIDocument(CDocument controller)
    {
        initComponents();
        this.setVisible(true);
        this.setTitle("GESTIÓN DE DOCUMENTO");
        setLocationRelativeTo(null);
        
        this.controller = controller;
        controller.upload(tblDocument);
        
        cellSelectionModel = tblDocument.getSelectionModel();
        cellSelectionModel.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        
        cellSelectionModel.addListSelectionListener
                
        ((ListSelectionEvent event) -> {
            controller.updateState(tblDocument, chkActive);
        });
        
        controller.loadAutoCompleter(txtSearch, tblDocument);
    }
    ...
    private void initComponents() {
        ...
        setIconImage(new javax.swing.ImageIcon(getClass().getResource("/hulkstore_/resources/images/document_icon.png")).getImage());
        ...
        jLabel1.setText("GESTIÓN DE DOCUMENTO");
        ...
        tblDocument.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        controller.update(tblDocument);
    }//GEN-LAST:event_btnUpdateActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        controller.delete(tblDocument, chkActive);
    ...
    private void chkActiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkActiveActionPerformed
        controller.enableDisable(tblDocument, chkActive);
    }//GEN-LAST:event_chkActiveActionPerformed

    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
       controller.selectRow(txtSearch, tblDocument);

...
public class UserUpdateTest
{
    ...
    public UserUpdateTest(int userId, String user_Name, String userPass, String identification, String realName, String surname, short userProfile, short state)
    {
        this.userId = userId;
    ...
    public static Collection data()
    {
        ...
        {
            {999999, "TestAdmin", "Test 1", "61914591", "Test", "Update", (short) 1, (short) 1},
            {999998, "TestUser", "Test 2", "61914591", "Test", "Update", (short) 0, (short) 1}
        });
    }
